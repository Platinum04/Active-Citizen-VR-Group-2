...
namespace VehicleBehaviour.Utils {
	public class CameraFollow : MonoBehaviour {
		...
		void FixedUpdate() {
			...
			if (transform.position.y < groundMinDistance) {
				transform.position = new Vector3(transform.position.x , groundMinDistance, transform.position.z);
			}
